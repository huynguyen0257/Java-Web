<%-- 
    Document   : login
    Created on : Oct 10, 2018, 1:07:13 PM
    Author     : Chuối
--%>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <form class="form" action="MainController" method="POST">
                                                ...
                                                ${requestScope.INVALID.confirmPasswordError}<br/>
                                                ${requestScope.INVALID.genderError}<br/>
                                                ...
                                                <div class="card-content">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group is-empty"><input class="form-control" type="text" placeholder="Username..." name="txtUsername" value="${param.txtUsername}"><span class="material-input"></span></div>
                                                    </div>
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                            <i class="material-icons">lock</i>
                                                        </span>
                                                        <div class="form-group is-empty"><input class="form-control" type="password" placeholder="Password..." name="txtPassword"><span class="material-input"></span></div>
                                                    </div>
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                            <i class="material-icons">lock_outline</i>
                                                        </span>
                                                        <div class="form-group is-empty"><input class="form-control" type="password" placeholder="Confirm Password" name="txtConfirmPassword" ><span class="material-input"></span></div>
                                                    </div>
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                            <i class="material-icons">chevron_right</i>
                                                        </span>
                                                        <div class="form-group is-empty"><input class="form-control" type="text" placeholder="Fullname..." name="txtFullname" value="${param.txtFullname}"><span class="material-input"></span></div>
                                                    </div>
                                                    <div class="input-group">
                                                        <label>Gender :</label>
                                                        <span class="input-group-addon">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group is-empty"><input class="form-control" name="txtBirthday" type="date"><span class="material-input"></span></div>
                                                    </div>
                                                    <!-- If you want to add a checkbox to this form, uncomment this code -->
                                                    <div class="checkbox">
                                                        <label>
                                                            <input name="checkCheckbox" type="checkbox" value="checked"><span class="checkbox-material"></span> I agree to the
                                                            <a href="#">terms and conditions</a>.
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="footer text-center">
                                                    <button type="submit" class="btn btn-primary btn-round" name="action" value="Create">Get Start</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
