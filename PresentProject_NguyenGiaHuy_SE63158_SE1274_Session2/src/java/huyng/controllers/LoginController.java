...
public class LoginController extends HttpServlet {
    ...
    private static final String MANAGEREVENT = "manageEvent.jsp";
    private static final String MANAGERUSER = "manageUser.jsp";
        ...
        try {
            ...
            if (valid) {
                ...
                if (role.equalsIgnoreCase("admin")) {
                    ...
                    errorObj.setUsernameError("*Username or Password incorrect!");
