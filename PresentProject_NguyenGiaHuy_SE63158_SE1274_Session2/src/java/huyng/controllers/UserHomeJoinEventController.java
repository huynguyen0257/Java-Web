 ...
 * @author Chuối
 */
public class UserHomeJoinEventController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(bean.userJoinInEvent()){
                url = "UserHomeEventSearchController";
            }else{
                request.setAttribute("ERROR", "Join fails");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }finally{
